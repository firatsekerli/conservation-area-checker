				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php esc_html_e( 'Default 0 checks the exact postcode point, which matches authoritative checkers and is the most precise. Increasing this also flags conservation or Article 4 areas within the given distance of the point, which catches more near-miss cases on tiny areas but can over-report next to a boundary. Applies to the live lookup.', 'conservation-area-checker' ); ?></p>
						</td>
					</tr>
					<tr>
